                ...
                <div className={style.dashboard}>
                    <div className={style.login}>
                        ...
                        <div className={style.form}>
                            ...
                            <div className={style.inner__hide}>
                                <input className={style.input} type={visible ? "text" : "password"} name="pass" placeholder="Пароль" />
                    ...
                    <div className={style.registration}>
                        ...
                        <div className={style.form}>
                            ...
                            <div className={style.inner__hide}>
                                <input className={style.input} type={visible ? "text" : "password"} name="pass" placeholder="Повторите пароль" />
