        ...
        <section>
            ...
            <ul className={style.inner}>
                <li className={style.item}>
                    ...
                    <h2 className={style.title}>Скидки при онлайн оплате</h2>
                </li>
                <li className={style.item}>
                    <svg className={style.icon}>
                        <use xlinkHref="#truck-solid" />
                    </svg>
                    <h2 className={style.title}>Быстрая Доставка</h2>
                </li>
                <li className={style.item}>
                    <svg className={style.icon}>
                        <use xlinkHref="#box-open-solid" />
                    </svg>
                    <h2 className={style.title}>Удобный возврат</h2>
                </li>
                <li className={style.item}>
                    <svg className={style.icon}>
                        <use xlinkHref="#balance-scale-solid" />
                    </svg>
                    <h2 className={style.title}>Гарантия полгода</h2>
                </li>
            </ul>
        </section>
    )
